...
class Camera(BaseCamera):
    ...
    # video_source = r'D:\Projects\hmara btp\hmara btp\cat.mp4'
    video_source = 0
    ...
    def frames():
        thres=0.56
        classNames= []
        classFile = r'D:\Projects\hmara btp\hmara btp\coco.names'
        with open(classFile,'rt') as f:
            classNames = f.read().rstrip('\n').split('\n')
        
        # To configure the input data
        configPath = r'D:\Projects\hmara btp\hmara btp\ssd_mobilenet_v3_large_coco_2020_01_14.pbtxt'

        # trained dataset
        weightsPath = r'D:\Projects\hmara btp\hmara btp\frozen_inference_graph.pb'
    ...
    #print(classIds,bbox)
            ...
            if len(classIds) != 0:
                for classId, confidence,box in zip(classIds.flatten(),confs.flatten(),bbox):
                    ...
                    if label=='CAR' or label =='TRUCK' or label=='MOTORCYCLE' or label=='BICYCLE' or label=='BUS' or label=='CAT' or label=='BIRD' or label=='COW' or label=='DOG':
            ...
            for c in cnts:
                ...
                if label=='COW' or label=='DOG' or label=='BIRD' or label=='CAT':
